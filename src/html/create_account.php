...
//Check if users is already connected
session_start();
...
<body>
    <div class="fullBody">
        ...
        <div class="fullForm">
            ...
            <!--Form where you create yours account-->
            <form class="form" action="" method="post">
                <div class="formFields">
                    ...
                    <div class="connectionField">
                        ...
                        <input type="text" class="loginInputs" name="usrEmail" placeholder="Entrez votre adresse E-Mail"
                            required />
                    </div>
                    <div class="connectionField">
                ...
                <!--Link if you have already an account-->
