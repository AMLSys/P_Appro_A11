...
<?php
    //Query to select every items from the clothes
    $fkType = 3;
...
<head>
    <!--
        ...
        -->
    <title>Bouldero - Vêtements</title>
    <meta charset="utf-8" />
...
<body>
    ...
    <div class="ariane">
        ...
        <div class="ariane-article">Vêtements</div>
    </div>
    <!--Title-->
    <div class="flex-nb-products">
        <div class="title-nb-products">Vêtements</div>
