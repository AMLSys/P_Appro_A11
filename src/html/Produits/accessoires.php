...
<?php
    //Query to select every items from the accessory
    $fkType = 5;
...
<head>
    <!--
        ...
        -->
    <title>Bouldero - Accessoires</title>
    <meta charset="utf-8" />
...
<footer><?php includeWithVariables('../../../resources/siteparts/footer.php', array('accessoires' => 'TRUE')); ?>
</footer>
</html>
