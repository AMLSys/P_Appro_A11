...
<?php
//Query made to select the data that are gooing to be used in the carrousel
$query = "SELECT idArticle, artBrand, artModel, artPrice, artDescription, artImage FROM t_articles";
$data = connectToDatabase($query); ?>
<?php session_start(); ?>
<?php //Select only the firsts 8 articles in the carrousel
$lowvalue = 0; $highvalue = 8; ?>
<!DOCTYPE html>
<html lang="fr">
...
<body>
    <!--Offres for some new climbing shoes-->
    <div class="flex-body">
